...
$(document).ready(function(){
  ...
  $(".jiathis_button_weixin").mouseenter(function(){
      $(this).children().children('.weichatshare').css("background-color","#46BC45");
  });
  $(".jiathis_button_weixin").mouseleave(function(){
      $(this).children().children('.weichatshare').css("background-color","#fafafa");
  });
...
$(function(){
  $("body").on("click", '.btn-dp', function(){
    ...
    commnetcount = node.find('.childcomment').length
    $(this).next(".form-comment-reply").fadeToggle(function(){
      var display = node.css("display");
      if (display == 'none'){
        if (commnetcount == 0){
        $(this).parent().children('.btn-dp').html('<i class="icon-dp-checkbox"></i> 添加点评')
        }
        else{
        ...
        $(this).parent().children('.btn-dp').html('<i class="icon-dp-checkbox"></i> 收起点评')
      }
    });
  });
})
